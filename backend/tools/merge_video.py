...
def merge_video(video_input_path1, video_input_path2, video_output_path):
    """
    将两个视频文件安装水平方向合并
    """
    ...
    size = (int(input_video_cap1.get(cv2.CAP_PROP_FRAME_WIDTH)), int(input_video_cap2.get(cv2.CAP_PROP_FRAME_HEIGHT)) * 2)
    ...
    while True:
        ...
        if not ret1 and not ret2:
            ...
            show = cv2.vconcat([frame1, frame2])
...
if __name__ == '__main__':
    ...
    v2_path = '../../test/test1_no_sub(bak2).mp4'
